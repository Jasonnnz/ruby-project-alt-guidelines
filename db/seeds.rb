...
u2 = User.create(name: "Peepo", username: "pepe", password: "MVP")
u3 = User.create(name: "Jason", username: "jason", password: "1")
u4 = User.create(name: "Erwin", username: "monke", password: "2")
...
r4 = Review.create(rating: 4, description: "I had a cat named Basil once.", product_id: basil.id, user_id: u4.id)
...
r9 = Review.create(rating: 5, description: "I have no idea what those idiots running this company are doing. Absolute garbage, lowest quality ingredient you could ever find.", product_id: parsley.id, user_id: u4.id)
...
r12 = Review.create(rating: 3, description: "Dis appe issa waist o' thyme", product_id: thyme.id, user_id: u4.id)
...
r19 = Review.create(rating: 3, description: "Sexy, fresh, wait what were we talking about again", product_id: cumin.id, user_id: u4.id)
...
r24 = Review.create(rating: 2, description: "Caviar is really expensive and tasty. This is just plain cheap.", product_id: smoked_paprika.id, user_id: u4.id)
...
r28 = Review.create(rating: 5, description: "Careful, this product is really really spicy. Make sure a bathroom is nearby!", product_id: black_pepper.id, user_id: u4.id)
...
r32 = Review.create(rating: 4, description: "Goes well with anything -- sent from my bathroom", product_id: black_pepper.id, user_id: u4.id)
